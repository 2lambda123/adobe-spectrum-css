...
// import fetchTokenData from "../../tasks/fetchTokenData.js";
...
const isMigrated = (dependencies) => !!(dependencies && dependencies["@spectrum-css/tokens"]);
...
async function fetchRenderData(cwd) {
    ...
    for (const file of pages) {
        ...
        compiledData.push({
            ...
            permalink: `components/${folder}/${fileBasename}/index.html`,
            parent,
            package: packageJSON,
            releaseDate,
            dependencies,
