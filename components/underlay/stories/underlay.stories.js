...
export default {
    ...
    parameters: {
        ...
        status: {
            type: process.env.MIGRATED_PACKAGES.includes("underlay") ? "migrated" : "legacy",
        },
    },
};
...
Default.args = {
    isOpen: true,
    content: ["This is a underlay. Don't use it like this. Use it with a Modal and a Dialog."],
};
