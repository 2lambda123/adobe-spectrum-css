...
export default {
    ...
    parameters: {
        ...
        status: {
            type: process.env.MIGRATED_PACKAGES.includes("clearbutton") ? "migrated" : "legacy",
        },
    },
};
...
OverBackground.decorators = [
    (Story) => html` <div style="background-color: rgb(15, 121, 125); padding: 15px 20px;">${Story()}</div> `,
];
