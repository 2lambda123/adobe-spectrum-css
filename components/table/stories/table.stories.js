...
export default {
    ...
    parameters: {
        ...
        status: {
            type: process.env.MIGRATED_PACKAGES.includes("table") ? "migrated" : "legacy",
        },
    },
};
...
SummaryAndSelected.parameters = {
    docs: {
        description: {
            story: "An example showing both the optional summary row, and a row marked as selected.",
        },
    },
};
...
Scrollable.parameters = {
    docs: {
        description: {
            story: "An example showing the use of the scrollable wrapper element with table markup. This allows a fixed height and scrolling, along with column headers that are fixed to the top on scroll.",
        },
    },
};
Scrollable.args = {
...
DivsScrollable.parameters = {
    docs: {
        description: {
            story: "A table can also be made up of divs if needed. This uses both the div markup, and the scrollable wrapper.",
        },
    },
};
...
Collapsible.args = {
    rowItems: [
        ...
        {
            cellContent: ["Table Row Charlie", "Default Not Visible", "Default Not Visible"],
            isCollapsible: true,
            isHidden: true,
            tier: 2,
            id: "table-cr-charlie",
