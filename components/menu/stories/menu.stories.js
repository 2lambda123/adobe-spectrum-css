...
export default {
    ...
    parameters: {
        ...
        status: {
            type: process.env.MIGRATED_PACKAGES.includes("menu") ? "migrated" : "legacy",
        },
    },
};
    ...
    items: [
        {
            ...
            idx: 1,
            items: [{ label: "Action 1" }, { label: "Action 2" }, { label: "Action 3" }],
        },
        { type: "divider" },
        {
            heading: "Section Heading",
    ...
    items: [
        {
            ...
            id: "menu-heading-sf",
            items: [{ label: "Financial District" }, { label: "South of Market" }, { label: "North Beach" }],
        },
        { type: "divider" },
        {
            idx: 2,
...
IconsAndDescriptions.parameters = {
    docs: {
        description: {
            story: "A few different variants and states are demonstrated in this story. Menu items are shown with icons, with short descriptions, and with both. A selected item and a disabled item are shown for each. A max-width is set for the story, to test the text wrapping.",
        },
    },
};
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    label: "A Menu Item With a Longer Label That Causes The Text to Wrap",
                    description:
                        "A description that is longer than average and is forced to wrap with an example max width.",
                },
                {
                    label: "Disabled Menu Item",
...
SingleSelection.parameters = {
    docs: {
        description: {
            story: "For single selection menu sections, menu items show a single checkmark to indicate the selected item.",
        },
    },
};
...
DrillInSubmenu.parameters = {
    docs: {
        description: {
            story: "When a menu item contains a submenu, a drill-in chevron will appear at the end of the menu item to show that a submenu is available.",
        },
    },
};
DrillInSubmenu.args = {
