    ...
    return html`
        ...
        >
            <div class="${rootClass}-header">
                <div class="${rootClass}-title" role="heading" aria-live="assertive" aria-atomic="true">
                    ...
                    <thead role="presentation">
                        <tr role="row">
                            ${repeat(
                                DOW,
                                (day) =>
                                    html` <th role="columnheader" scope="col" class="${rootClass}-tableCell">
                                    ...
                                    ${repeat(
                                        ...
                                        (thisDay) =>
                                            html` <td
                                                ...
                                                tabindex=${!thisDay.isOutsideMonth ? "-1" : undefined}
