...
`;
  ...
  this.popover.addEventListener(
    "keydown",
    this.handlePopoverNavigation.bind(this)
  );
  ...
  this.el.addEventListener(
    ...
    function (e) {
      if (
        ...
        !this.popover.contains(e.relatedTarget)
      ) {
...
Search.prototype.handlePopoverNavigation = function (e) {
  ...
  if (currentItem.classList.contains("spectrum-Menu-item")) {
    let items = Array.prototype.slice.call(
      this.popover.querySelectorAll(".spectrum-Menu-item")
    );
